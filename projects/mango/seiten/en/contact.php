	    ...
	    <div id="container">
			...
			<div id="content">
				...
				<div class="clearme">
					...
					?>
					<div id="messageSent">
						Your message has been succesfully sent ! We'll get back to you soon. <br>
						Here's the summary of what you sent us. <br>
						<div id="summary">
					<?php
							// we show it
					...
					<div id="contact">
						<form id="contactForm" method="POST" action="contact.php">
							<p>
								<label class="form_col" for="lastName">Last Name :</label>
								<input name="lastName" id="lastName" type="text">
								<span class="tooltip">Your last name has to be longer than 2 characters.</span>
								<br><br>
							</p>
						
							<p>
								<label class="form_col" for="firstName">First Name :</label>
								<input name="firstName" id="firstName" type="text">
								<span class="tooltip">Your first name has to be longer than 2 characters.</span>
								<br><br>
							</p>
							...
							<p>
								...
								<span class="tooltip">Your message has to be longer than 10 characters.</span>
								<br><br>
							</p>
