	    ...
	    <div id="container">
			...
			<div id="content">
				...
				<div class="clearme">
					...
					?>
					<div id="messageSent">
						Votre message a été envoyé avec succès ! Nous vous répondrons dans les plus brefs délais. <br>
						Voici le récapitulatif de ce que vous nous avez envoyé. <br>
						<div id="summary">
					<?php
							// we show it
							echo '<strong>Nom</strong> : ' . $_POST['lastName'] . '<br>';
							echo '<strong>Prénom</strong> : ' . $_POST['firstName'] . '<br>';
					...
					<div id="contact">
						<form id="contactForm" method="POST" action="contact.php">
							<p>
								...
								<span class="tooltip">Votre nom doit faire plus de 2 caratères.</span>
								<br><br>
							</p>
							...
							<p>
								...
								<span class="tooltip">Votre message doit faire plus de 10 caratères.</span>
								<br><br>
							</p>
